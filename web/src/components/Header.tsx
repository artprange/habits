    ...
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between ">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/4 left-1/2 -translate-x-1/2 -translate-x-1/2">
            ...
            <Dialog.Title className="text-3l leading-tight font-extrabold">
              Criar Hábito
            </Dialog.Title>
            <NewHabitForm />
          </Dialog.Content>
